...
SYSTEM_TOOL_POLICIES: Final = MappingProxyType(
    {
        ...
        SystemToolName.START_EXPORT: ToolPolicy(Scope.USE, ("name",)),
        SystemToolName.GET_MY_EXPORT: ToolPolicy(Scope.USE, ("export_id",)),
        ...
        SystemToolName.LIST_OPERATION_REQUESTS: ToolPolicy(Scope.ADMIN),
        SystemToolName.RESOLVE_OPERATION_REQUEST: ToolPolicy(Scope.ADMIN, ("request_id",)),
